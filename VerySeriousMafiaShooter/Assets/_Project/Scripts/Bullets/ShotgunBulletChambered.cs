...
public class ShotgunBulletChambered : MonoBehaviour, IChamberedBullet
{
    ...
    {
        for(int i = 0; i < _bulletDataSO.ProjectileCount; i++)
        {
            SpawnBullet(origin, forwardDirection);
        }
    }

    private void SpawnBullet(Vector3 origin, Vector3 forwardDirection)
    {
